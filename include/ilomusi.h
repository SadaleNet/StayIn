...
//Graphic API
#define GRAPHIC_HEIGHT (8U)
#define GRAPHIC_WIDTH (128U)

#define GRAPHIC_SIZE (GRAPHIC_HEIGHT*GRAPHIC_WIDTH)

#define GRAPHIC_PIXEL_HEIGHT (GRAPHIC_HEIGHT*8U)
...
enum GraphicDisplayMode{
	GRAPHIC_DISPLAY_NORMAL, //0x0C. 0b00001100
	GRAPHIC_DISPLAY_INVERTED, //0x0D. 0b00001101
	GRAPHIC_DISPLAY_ALL_ON, //0x09. 0b00001001
	GRAPHIC_DISPLAY_ALL_OFF, //0x08. 0b00001000
	GRAPHIC_DISPLAY_NUM,
};
